...
type (
	...
	*/
	...
	TxStartHook = func(vm *VMContext, tx any, from common.Address)

	// TxEndHook is called after the execution of a transaction ends.
	TxEndHook = func(receipt any, err error)
	...
	*/
	...
	GenesisBlockHook = func(genesis any, alloc any)
